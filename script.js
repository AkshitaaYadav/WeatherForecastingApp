...
let weatherAPIKey = "08a9bbfc532eb23addb59728f7826f91";
...
searchInp.addEventListener("keydown", (e) => {
    if (e.keyCode === 13) {
        let weather = geatWeatherByCityName(searchInp.value);
        console.log(weather);
    }
});


let geatWeatherByCityName = async(city) => {
...
let weatherForCity = async(city) => {
    let weather = await geatWeatherByCityName(city);
    if (weather.cod === "404") {
        Swal.fire({
            icon: "eror",
            title: "OOPs...",
